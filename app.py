...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Thu - Trường PTDTBT Tiểu học Minh Sơn - ĐT: 0386389253</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn văn Thu - Trường PTDTBT Tiểu học Minh Sơn - ĐT: 0386389253</div>", unsafe_allow_html=True)
